...
CREATE TABLE district_census (
    geo_section char(8) NOT NULL,            -- level of geography (always district),
    district varchar(90) NOT NULL,           -- district name
    ...
    CONSTRAINT district_census_key PRIMARY KEY 
        (district, state, year, societal_section, 
            demo_section, water_source, water_avail) 
);

COPY district_census
FROM '/Users/seanangiolillo/Library/Mobile Documents/com~apple~CloudDocs/in_household/sql/district_census.csv'
