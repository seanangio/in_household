...
CREATE TABLE state_census (
    ...
    CONSTRAINT state_census_key PRIMARY KEY 
        (state, year, societal_section, 
        demo_section, water_source, water_avail)
);

COPY state_census
FROM '/Users/seanangiolillo/Library/Mobile Documents/com~apple~CloudDocs/in_household/sql/state_census.csv'
